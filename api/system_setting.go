...
const (
	// SystemSettingServiceIDName is the name of Service id.
	SystemSettingServiceIDName SystemSettingName = "Service-id"
	...
	// SystemSettingCustomizedProfileName is the name of customized Service profile.
...
type CustomizedProfile struct {
	// Name is the Service name, default is `memos`
	Name string `json:"name"`
	// LogoURL is the url of logo image.
	LogoURL string `json:"logoUrl"`
	// Description is the Service description.
	Description string `json:"description"`
	// Locale is the Service default locale.
	Locale string `json:"locale"`
	// Appearance is the Service default appearance.
	Appearance string `json:"appearance"`
	// ExternalURL is the external url of Service. e.g. https://usermemos.com
...
func (key SystemSettingName) String() string {
	switch key {
	case SystemSettingServiceIDName:
		return "Service-id"
...
func (upsert SystemSettingUpsert) Validate() error {
	if upsert.Name == SystemSettingServiceIDName {
		return errors.New("update Service id is not allowed")
